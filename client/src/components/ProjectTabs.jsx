            ...
            <div style={{ flex: 1, position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  fontFamily: "'TW Cen MT', 'Century Gothic'", fontWeight: 600, fontSize: 14,
                  ...
                  <div className="glass-card" style={{
                        ...
                        <div key={p.id}>
                          ...
                          {confirming && (
                            <div style={{
                              ...
                              <div style={{ fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 12, color: 'var(--text)', marginBottom: 8 }}>
                                Arhivirati projekat?
                              </div>
                              <div style={{ display: 'flex', gap: 8 }}>
                                <button onClick={() => setConfirmId(null)} style={{ flex: 1, padding: '6px', borderRadius: 6, border: '1px solid var(--border)', background: 'transparent', color: 'var(--textMuted)', fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 12, cursor: 'pointer' }}>
                                  Otkaži
                                </button>
                                <button onClick={() => handleArchiveConfirm(p.id)} style={{ flex: 1, padding: '6px', borderRadius: 6, border: 'none', background: 'var(--red)', color: '#fff', fontFamily: "'TW Cen MT', 'Century Gothic'", fontWeight: 600, fontSize: 12, cursor: 'pointer' }}>
                                  Arhiviraj
                                </button>
                              </div>
                            </div>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 12,
              ...
              <div style={{ position: 'relative' }}>
                ...
                {addHover && (
                  <div style={{
                    ...
                    fontSize: 12, fontFamily: "'TW Cen MT', 'Century Gothic'",
      ...
      {confirmId && !isMobile && (
        <>
          ...
          <div className="glass-card" style={{
            ...
            <div style={{ fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 13, color: 'var(--textMuted)', marginBottom: 20 }}>
              Projekat će biti premešten u arhivu. Sve metrike i istorija ostaju sačuvani. Možete ga vratiti u bilo kom trenutku.
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <button onClick={() => setConfirmId(null)} style={{ flex: 1, padding: '9px', borderRadius: 8, border: '1px solid var(--border)', background: 'transparent', color: 'var(--text)', fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 14, cursor: 'pointer' }}>
                Otkaži
              </button>
              <button onClick={() => handleArchiveConfirm(confirmId)} style={{ flex: 1, padding: '9px', borderRadius: 8, border: 'none', background: 'var(--red)', color: '#fff', fontFamily: "'TW Cen MT', 'Century Gothic'", fontWeight: 600, fontSize: 14, cursor: 'pointer' }}>
                Arhiviraj
              </button>
            </div>
          </div>
