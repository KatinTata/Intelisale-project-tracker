...
export default function BarChart({ data = [], width = 600, height = 260 }) {
  ...
  if (filtered.length === 0) return (
    <div style={{ height, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--textMuted)', fontFamily: "'DM Sans'" }}>
  ...
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      {/* Legend */}
      <div style={{ display: 'flex', gap: 16, marginBottom: 12, fontSize: 12, fontFamily: "'DM Sans'" }}>
