...
export default function Topbar({ user, theme, onOpenSettings, onLogout, onOpenUsers, unreadCount, recentUnread, onMarkAllRead, onNotificationClick, onOpenChat, onGoToReleaseNotes, onGoToEpicViewer }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        {onGoToEpicViewer && (
          <button
            onClick={onGoToEpicViewer}
            title="Release Notes pregled"
