    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--border)' }}>
          ...
          <p style={{ fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 13, color: 'var(--textMuted)', marginLeft: 34 }}>
        ...
        <div style={{ maxHeight: 280, overflowY: 'auto' }}>
          {notifications.map(n => (
            <div key={n.id} style={{ padding: '12px 24px', borderBottom: '1px solid var(--border)' }}>
              ...
              <p style={{ fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 13, color: 'var(--textMuted)', lineHeight: 1.5 }}>
        ...
        <div style={{ padding: '16px 24px', display: 'flex', gap: 10 }}>
          <button
            onClick={onOpenChat}
            style={{ flex: 1, background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 8, padding: '10px', fontFamily: "'TW Cen MT', 'Century Gothic'", fontWeight: 600, fontSize: 14, cursor: 'pointer' }}
          >
            Pogledaj sve →
          </button>
          <button
            onClick={onClose}
            style={{ background: 'transparent', color: 'var(--textMuted)', border: '1px solid var(--border)', borderRadius: 8, padding: '10px 16px', fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 14, cursor: 'pointer' }}
          >
            Zatvori
          </button>
        </div>
