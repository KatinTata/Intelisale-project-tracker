      ...
      <div className="glass-card" style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 13, color: 'var(--textMuted)' }}>
        ...
        <div style={{ padding: '20px 24px', overflowY: 'auto', flex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '7px 16px',
                    fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 13, cursor: 'pointer',
                  }}
                >
                  Otkaži
                </button>
          ...
          {/* Users list */}
          {loading ? (
            <div style={{ textAlign: 'center', padding: 32, color: 'var(--textMuted)', fontFamily: "'TW Cen MT', 'Century Gothic'" }}>
              Učitavam korisnike...
            </div>
          ) : users.length === 0 ? (
            <div style={{ textAlign: 'center', padding: 32, color: 'var(--textMuted)', fontFamily: "'TW Cen MT', 'Century Gothic'" }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: isAdmin ? 0 : 10 }}>
        ...
        <button
          ...
          style={{
            ...
            padding: '4px 10px',
            fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 12, cursor: 'pointer',
            transition: 'all 0.2s ease',
          }}
      ...
      {!isAdmin && <div style={{ marginBottom: 10 }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
          {user.projects.length === 0 ? (
            <span style={{ fontFamily: "'TW Cen MT', 'Century Gothic'", fontSize: 12, color: 'var(--textSubtle)', fontStyle: 'italic' }}>
